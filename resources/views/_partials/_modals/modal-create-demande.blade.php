<div wire:ignore.self class="modal fade" id="demande-create" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-simple modal-edit-user">
        <div class="modal-content">
            <div class="modal-body">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                <div class="text-center mb-6">
                    <h4 class="mb-2">Création d'une demande d'absence/congé</h4>
                    {{-- <p>Updating user details will receive a privacy audit.</p> --}}
                </div>
                <form id="editUserForm" class="row g-6" wire:submit.prevent='submit'>
                    ...
                    <div class="col-12 col-md-6">
                        <div wire:ignore>
                            <label class="form-label" for="type_conge">Type de congé/absence</label>
                            <select wire:model='typeConge' id="type_conge" name="type_conge" class="select2 form-select"
