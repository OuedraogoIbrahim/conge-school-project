...
<body style="font-family: 'Segoe UI', Arial, sans-serif; margin: 0; padding: 20px; background-color: #f0f2f5; text-align: center;">
    <table align="center" width="600" style="margin: 20px auto; background-color: #ffffff; border-radius: 16px; box-shadow: 0 8px 24px rgba(0, 0, 0, 0.1); border: none;">
        ...
        <tr>
            <td style="padding: 35px 20px; text-align: center; background: linear-gradient(135deg, #003366 0%, #004d99 100%); border-radius: 16px 16px 0 0;">
        ...
        <tr>
            <td style="padding: 0 30px;">
                <div style="background: linear-gradient(to right, #f8f9fa, #ffffff); border-left: 4px solid #003366; border-radius: 12px; padding: 20px; margin: 10px 0;">
                    ...
                    <table width="100%" style="border-collapse: collapse;">
                        ...
                        <tr>
                            <td style="padding: 8px 0;">
                                ...
                                <strong style="color: #003366; margin-left: 10px;">{{ $demande->date_debut }}</strong>
                            </td>
                            <td style="padding: 8px 0;">
                        ...
                        <tr>
                            <td colspan="2" style="padding: 15px 0 8px;">
                                ...
                                <strong style="color: #003366; margin-left: 10px;">{{ $demande->type_conge }}</strong>
                            </td>
                        </tr>
                        <tr>
        ...
        <!-- Pied de page -->
        <tr>
            <td style="padding: 25px; text-align: center; background: linear-gradient(to bottom, #f8f9fa, #ffffff); border-radius: 0 0 16px 16px;">
