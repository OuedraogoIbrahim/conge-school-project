...
(function () {
    // Flat Picker
    // --------------------------------------------------------------------
    const flatpickrDateDebut = document.querySelector("#flatpickr-date-debut"),
        flatpickrDateFin = document.querySelector("#flatpickr-date-fin"),
    ...
    // Date debut
    if (flatpickrDateDebut) {
        flatpickrDateDebut.flatpickr({
